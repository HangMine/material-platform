<template>
  <el-popper
    ...
    :manual-mode="true"
    :trigger="[trigger]"
    popper-class="sd-dropdown__popper el-dropdown__popper"
  ...
  >
    <template #default>
      <el-scrollbar ref="scrollbar" tag="ul" :wrap-style="wrapStyle" view-class="el-dropdown__list">
    ...
    <template #trigger>
      <div :class="['el-dropdown', dropdownSize ? 'el-dropdown--' + dropdownSize : '']">
        ...
        <template v-else>
          <el-button-group>
            <el-button :size="dropdownSize" :type="type" @click="handlerMainButtonClick">
              <slot name="default"></slot>
            </el-button>
            <el-button :size="dropdownSize" :type="type" class="el-dropdown__caret-button">
...
import { on, addClass, removeClass } from 'element-plus/packages/utils/dom';
import { addUnit, useGlobalConfig } from 'element-plus/packages/utils/util';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const triggerVnode = ref<ComponentPublicInstance>(null);
    const triggerElm = computed<HTMLButtonElement>(() => {
